...
import Banner from "../public/dbanner.jpg"
        ...
        <Card>
          ...
          <div className="p-2 ">
            <div className="flex items-center">
              ...
              <h1 className="font-medium pl-1">Home</h1>
            </div>
            <p className="text-sm text-muted-foreground pt-2">Your Home Damag frontpage. Come here to check in with your favorite community!</p>
