...
const rules = [
    ...
    { id: 3, text: "Look for the source content" },
    ...
    return (
        <div className="max-w-[1000px] mx-auto flex gap-x-10 mt-4">
            <div className="w-[65%] flex flex-col gap-5">
                <h1 className="font-semibold">Subdamag: 
                    <Link href={`/r/${params.id}`} className="text-primary"> d/{params.id}</Link>
                </h1>
                        ...
                        <Card className="mb-10">
                            <CardHeader>
                                {imageUrl === null ? (
                                    ...
                                    <Image src={imageUrl} alt="uploaded image" width={500} height={400} />
                                )}
                            </CardHeader>
                        </Card>
                    </TabsContent>
            ...
            <div className="w-[35%]">
                <Card className="flex flex-col p-4">
                    <div className="flex items-center gap-x-4">
                        ...
                        <h1 className="font-medium">Posting to Damag</h1>
                    </div>
